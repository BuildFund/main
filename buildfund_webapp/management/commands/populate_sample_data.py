...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Populating BuildFund database with sample data..."))
        self.stdout.write("=" * 60)
        ...
        if created:
            ...
            borrower1.save()
            self.stdout.write(self.style.SUCCESS(f"   Created borrower: {borrower1.username}"))
        else:
            self.stdout.write(f"   Using existing borrower: {borrower1.username}")
        ...
        if created:
            ...
            borrower2.save()
            self.stdout.write(self.style.SUCCESS(f"   Created borrower: {borrower2.username}"))
        else:
            self.stdout.write(f"   Using existing borrower: {borrower2.username}")
        ...
        if created:
            ...
            lender1.save()
            self.stdout.write(self.style.SUCCESS(f"   Created lender: {lender1.username}"))
        else:
            self.stdout.write(f"   Using existing lender: {lender1.username}")
        ...
        if created:
            ...
            lender2.save()
            self.stdout.write(self.style.SUCCESS(f"   Created lender: {lender2.username}"))
        else:
            self.stdout.write(f"   Using existing lender: {lender2.username}")
        ...
        for project_data in projects_data:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f"   Created project: {project.address}, {project.town} ({project.status})"))
            else:
                self.stdout.write(f"   Project already exists: {project.address}, {project.town}")
        ...
        for product_data in products_data:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f"   Created product: {product.name} ({product.status})"))
            else:
        ...
        if approved_projects.exists() and active_products.exists():
            ...
            if matching_product:
                ...
                if created:
                    self.stdout.write(self.style.SUCCESS(f"   Created application: Project {project.id} → {matching_product.lender.organisation_name} ({application.status})"))
                else:
                    self.stdout.write(f"   Application already exists for this project")
        ...
        self.stdout.write("=" * 60)
        self.stdout.write("\nCreated:")
        self.stdout.write(f"  - {User.objects.filter(borrowerprofile__isnull=False).count()} borrowers")
        self.stdout.write(f"  - {User.objects.filter(lenderprofile__isnull=False).count()} lenders")
        ...
        self.stdout.write("  Borrower 1: borrower1 / password123")
        self.stdout.write("  Borrower 2: borrower2 / password123")
        self.stdout.write("  Lender 1: lender1 / password123")
        self.stdout.write("  Lender 2: lender2 / password123")
        self.stdout.write("\n" + self.style.SUCCESS("You can now test the system with this sample data!"))
